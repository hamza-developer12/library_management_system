...
class AllocateBookScreen extends StatefulWidget {
  const AllocateBookScreen({super.key});

  @override
  State<AllocateBookScreen> createState() => _AllocateBookScreenState();
}

class _AllocateBookScreenState extends State<AllocateBookScreen> {
  String? _scanResult;
